...
上面$1/r$这种简单的概率密度函数，我们很好做积分，但是实际上概率密度函数是很复杂的，难以积分！

那我们能不能将复杂的概率密度函数转化为容易积分的概率密度函数呢？当然可以！

下图蓝色是实际的PDF，橙色的是简单易积分的近似PDF

<img src="../../images/重要性采样.png" alt="重要性采样" style="zoom:67%;" />

#### BRDF生成she'x

> 感觉上面讲重要性采样有些喧宾夺主了，在这里使用重要性采样，目的实际上为了求反射光的方向

射线很宝贵，要发射有价值的射线

射线的发射位置使用[Halton Sequences](https://www.pbr-book.org/3ed-2018/Sampling_and_Reconstruction/The_Halton_Sampler)生成
